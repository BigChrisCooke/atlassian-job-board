...
export function normaliseLocation(raw: string): string {
  ...
  if (s.match(/new york|san francisco|austin|seattle|boston|chicago|salt lake city|denver|atlanta|los angeles|dallas|portland|usa|united states|\b(al|ak|az|ar|ca|co|ct|de|fl|ga|hi|id|il|in|ia|ks|ky|la|me|md|ma|mi|mn|ms|mo|mt|ne|nv|nh|nj|nm|ny|nc|nd|oh|ok|or|pa|ri|sc|sd|tn|tx|ut|vt|va|wa|wv|wi|wy|dc)\b/)) return 'usa';
