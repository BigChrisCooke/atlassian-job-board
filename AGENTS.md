...
These apply to every Codex session on this repo.
...
- The maintainer is on Codex Max — that quota covers interactive Codex sessions, NOT scheduled CI runs. Any LLM in CI must use a free path.
